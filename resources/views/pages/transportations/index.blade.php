...
@section('content_header')
    ...
    <div class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Angkot</h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Home</a></li>
                        <li class="breadcrumb-item active">Angkot</li>
                    </ol>
                </div>
                <div class="col-sm-6">
                    <div class="float-sm-right">
                        <a href="{{ route('admin.transportations.create') }}" class="btn btn-primary">Tambah</a>
                    </div>
                </div>
            </div>
        </div>
...
@section('js')
    <script>
        const datatablesUrl = "{{ route('admin.transportations.index') }}";
